...
@section('content')
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            @endif
                <h2 style="text-align: center">Edit tag</h2> <br>
        ...
        <div class="col-md-6">
            <input id="aunamethor" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{  $tag->name}}" required>
